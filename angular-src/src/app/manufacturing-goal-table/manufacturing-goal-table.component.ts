...
export class ManufacturingGoalTableComponent implements OnInit {
  ...
  constructor(private authenticationService: AuthenticationService, public manufacturingService: ManufacturingGoalService, private snackBar: MatSnackBar, public dialog: MatDialog) { }
